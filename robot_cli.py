...
@cli.command()
@click.argument('name')
@click.option('--model', help='Update robot model')
@click.option('--status', help='Update robot status')
@click.option('--hostname', help='Update hostname')
@click.option('--deployed', help='Update deployment status (true/false)')
@click.option('--aspect', '-a', multiple=True, nargs=2, help='Update aspect value')
